...
<!--begin::filter-->
<div class="" id="kt_toolbar" data-select2-id="select2-data-kt_toolbar">
    <!--begin::Container-->
                ...
                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                    ...
                    <div class="px-7 py-5">
                        ...
                        <div class="mb-10" data-select2-id="select2-data-71-lj6v">
                            ...
                            <!--begin::Input-->
                            <div>
                                <form action="{{ route('filtreSeries') }}" method="post">
                                    {{ csrf_field() }}
                                    <select class="form-select form-select-solid select2-hidden-accessible"
                                        name="category_id" data-kt-select2="true" data-placeholder="Select option"
...
<div class="text-center mb-17">
    <!--begin::Title-->
    <h3 class="fs-2hx text-dark mb-5" id="how-it-works" data-kt-scroll-offset="{default: 100, lg: 150}">Our Series</h3>
    <!--end::Title-->
</div>
<!--end::Heading-->
