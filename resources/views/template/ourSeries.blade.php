...
<!--begin::filter-->
 <div class="toolbar" id="kt_toolbar" data-select2-id="select2-data-kt_toolbar">
                            ...
                            <div class="mb-10" data-select2-id="select2-data-71-lj6v">
                                ...
                                <div>
                                    <select class="form-select form-select-solid select2-hidden-accessible"
                                        ...
                                        dir="ltr" data-select2-id="select2-data-8-n7ym" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-eqlw-container"
                                                aria-controls="select2-eqlw-container"><span
                                                    class="select2-selection__rendered" id="select2-eqlw-container"
    ...
    <div class="text-center mb-17">
        <!--begin::Title-->
        <h3 class="fs-2hx text-dark mb-5" id="how-it-works" data-kt-scroll-offset="{default: 100, lg: 150}">Latest
            Movies</h3>
        <!--end::Title-->
    </div>
    <!--end::Heading-->
